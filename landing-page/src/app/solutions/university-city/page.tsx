...
const intros: SolutionIntroductionProps["introductions"] = [
  {
    title: "心理筛查",
    description:
      "象导生涯提供多维度筛查体系，采用国际标准化量表，通过学生端APP/PC端完成测评，自动生成心理风险等级，辅助预警。",
  ...
  },
  {
    title: "生涯成熟度评估",
    description:
      "基于生涯理论设计测评模块，评估职业兴趣、决策能力、未来取向等维度，识别生涯迷茫或发展滞后学生",
  ...
  },
  {
    title: "数据分析",
    description:
      "学校仅需1小时即可完成1000人的筛查过程，校级管理员/教师可查看班级数据聚合报告（如心理危机比例、生涯决策困难的分布）。",
...
const advantages: SolutionAdvantagesSectionProps["advantages"] = [
  {
    title: "筛查效率高",
    description:
      "传统筛查模式效率低、耗时长，量表数据统计工作量大，象导生涯1小时即可完成1000人的筛查。",
    image: "/images/solutions/university-city/advantages/advantages-1.png",
  },
  {
    title: "生态化整合",
    description:
      "可对接现有校园管理体系(如学籍信息)，支持PC端、手机端的联动，实现学生课后筛查数据同步。",
    image: "/images/solutions/university-city/advantages/advantages-2.png",
  },
  {
    title: "可持续性高",
    description:
      "基于象导生涯学生发展指导智慧平台SaaS模式，在政策更新时，测评模块可快速迭代。学校无需维护服务器，无后期运营成本。",
