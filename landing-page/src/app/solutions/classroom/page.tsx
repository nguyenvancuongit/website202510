...
const advantages = [
  ...
  },
  {
    ...
    description:
      "教师可通过学生发展指导智慧平台安排心理健康/生涯适应力测评任务。学生完成测评后，平台根据量表常模自动生成个体评估报告，帮助教师了解班级学生情况，有针对性地提供心理/生涯指导。此外，平台会筛选出现心理危机预警或生涯适应力较低的学生名单，以便教师及时进行干预和辅导。",
...
const introductions = [
  ...
  },
  {
    title: "生涯课堂平板电脑",
    description:
      "内置不同侧重点的测评量表和数字化生涯探索工具，增进生涯课堂师生和生生互动。学生的量表测评数据/生涯探索工具使用结果实时同步至教师端，并记录到学生的生涯成长档案为个性化生涯指导提供参考。集成信息库、智能选科、量表和工具等功能，适应认识自我、认识外部世界、决策与行动等不同阶段的学生发展需求。",
