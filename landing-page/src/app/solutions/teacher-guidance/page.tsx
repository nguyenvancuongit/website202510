    ...
    <SolutionPageGuard pageKey="teacher-guidance">
      <div className="min-h-screen">
        ...
        <SolutionIntroduction
          title="方案介绍"
          description="象导生涯具备师资队伍培训认证资格，通过专家课程和线下讲座方式，从教案使用、量表解读、咨询流程、个案实操等多方面系统化的开展培训，通过理论与实操相结合的方式帮助教师掌握生涯教育的核心理论和指导技能，助力提升教师指导力，使其能够掌握并独立运用生涯咨询手段和辅导技术对学生开展发展指导工作，未来成为区域内生涯教育领域的中坚力量。"
