...
const timelineRows = [
  {
    right: { date: "2019.08", text: "科象教育（广州）有限公司成立" },
    left: {
      date: "2022.08",
      text: "纬英学生发展研究院成立",
    },
  },
  {
    right: {
      date: "2023.03",
      text: "学生发展指导智慧云平台教师端上线、可实现大规模普查、一对一咨询等各类咨询服务",
    },
    left: {
      date: "2023.08",
  ...
  },
  {
    right: {
      date: "2023.08",
      text: "首次利用学生发展指导智慧云平台助力开展广东省生涯教师指导培训",
    },
    left: {
      date: "2023.09",
  ...
  },
  {
    right: {
      date: "2025.09",
      text: "纬英科技推出聚焦于生涯教育领域的全新品牌“象导生涯”，更专注服务于生涯教育的服务与发展",
    },
  },
]
