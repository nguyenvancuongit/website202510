...
const timelineData = [
  ...
  },
  {
    ...
    title: "推进育人方式改革",
    description:
      "《国务院办公厅关于新时代推进普通高中育人方式改革的指导意见》要求通过学科教学渗透、开设指导课程、开展职业体验等对学生进行指导，并构建家校社协同指导机制加强对学生理想、心理、学习、生活、生涯规划等方面指导，帮助学生树立正确理想信念、正确认识自我，处理好个人兴趣特长与国家和社会需要的关系，提高选修课程、选考科目、报考专业和未来发展方向的自主选择能力。",
    background:
