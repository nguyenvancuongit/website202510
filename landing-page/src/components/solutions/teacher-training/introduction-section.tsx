...
const TeacherTrainingIntroductionSection = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20 lg:pb-50">
      ...
      >
        象导生涯教师生涯辅助解决方案，依托国内外生涯教育专家顾问团队，精选科学权威的量表、工具，整合全国院校信息库等多元资讯，打造覆盖中学阶段生涯教育资源包，帮助教师快速理解生涯教育理论、理解实践案例、掌握量表工具使用。教师可利用平台上的课件资源针对本校实际情况、不同教育阶段和任务开展多元化生涯课程，也可面向个体学生进行针对性测评和指导，帮助学生做好符合其自身特质的生涯规划和学业指导工作。
      </motion.p>
